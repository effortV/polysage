...
MATERIAL_QUERIES: dict[str, tuple[str, list[str]]] = {
    "R1": ("再生高压一级透明 PE 颗粒，吹膜用", ["再生PE 颗粒 价格表 今日 报价", "再生高压一级透明料 颗粒 厂家 报价",
                                 "废塑料 再生LDPE 一级 透明 造粒 价格", "site:1688.com 再生高压 一级 透明 颗粒"]),
    "R2": ("再生高压二级 PE 颗粒", ["再生高压二级料 颗粒 价格 厂家", "再生LDPE 二级料 报价"]),
    "RL": ("再生线性一级料（工业膜回料造粒）", ["再生PE 颗粒 价格表 今日 报价", "再生线性 LLDPE 一级 颗粒 厂家 报价",
                              "工业膜 回料 造粒 线性 价格", "site:1688.com 再生线性 一级 颗粒"]),
    ...
    "EVA": ("EVA 膜级，VA 5～9%", ["EVA 树脂 价格 报价 今日 华东", "EVA 14-2 价格 报价 膜级", "EVA VA含量 6% 吹膜 价格 厂家"]),
    ...
    "FL": ("CaCO₃ 填充母料（碳酸钙含量 80%）", ["碳酸钙填充母料 价格 厂家 吹膜 报价", "填充母料 80% 碳酸钙 多少钱一吨",
                              "site:1688.com 填充母料 碳酸钙 吹膜"]),
    "TFL": ("透明填充母料（细粒径 CaCO₃/BaSO₄）", ["透明填充母料 价格 厂家 吹膜"]),
    "TALC": ("滑石粉母料", ["滑石粉母料 价格 厂家"]),
    "AD": ("聚乙烯吹膜用功能母粒：氟聚合物加工助剂（PPA，消除鲨鱼皮）+ 抗氧剂，不是工程塑料聚邻苯二甲酰胺",
           ["聚乙烯 加工助剂 母粒 氟聚合物 价格 厂家", "吹膜 PPA 母粒 鲨鱼皮 价格 报价", "抗氧剂母粒 聚乙烯 价格 厂家"]),
